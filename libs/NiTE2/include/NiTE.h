...
public:
	...
	*/
	Status_ create(openni::Device* pDevice = NULL)
	{
		if (isValid())
		{
		...
		if (pDevice == NULL)
		{
			return (Status_)niteInitializeUserTracker(&m_userTrackerHandle);
		}
		return (Status_)niteInitializeUserTrackerByDevice(pDevice, &m_userTrackerHandle);
	}
	...
	*/
	Status_ readFrame(UserTrackerFrameRef* pFrame)
	{
		NiteUserTrackerFrame *pNiteFrame = NULL;
		Status_ rc = (Status_)niteReadUserTrackerFrame(m_userTrackerHandle, &pNiteFrame);
	...
	*/
	Status_ setSkeletonSmoothingFactor(float factor)
	{
		return (Status_)niteSetSkeletonSmoothing(m_userTrackerHandle, factor);
	}
	...
	*/
	...
	{
		float factor;
		Status_ rc = (Status_)niteGetSkeletonSmoothing(m_userTrackerHandle, &factor);
		if (rc != STATUS_OK)
		{
			factor = 0;
		}
	...
	*/
	Status_ startSkeletonTracking(UserId id)
	{
		return (Status_)niteStartSkeletonTracking(m_userTrackerHandle, id);
	}
	...
	*/
	Status_ startPoseDetection(UserId user, PoseType type)
	{
		return (Status_)niteStartPoseDetection(m_userTrackerHandle, (NiteUserId)user, (NitePoseType)type);
	}
	...
	*/
	Status_ convertJointCoordinatesToDepth(float x, float y, float z, float* pOutX, float* pOutY) const
	{
		return (Status_)niteConvertJointCoordinatesToDepth(m_userTrackerHandle, x, y, z, pOutX, pOutY);
	}
	...
	convert between coordinate systems requires a properly initalized Device from OpenNI 2.0.
	*/
	Status_ convertDepthCoordinatesToJoint(int x, int y, int z, float* pOutX, float* pOutY) const
	{
		return (Status_)niteConvertDepthCoordinatesToJoint(m_userTrackerHandle, x, y, z, pOutX, pOutY);
	}
...
public:
	...
	*/
	Status_ create(openni::Device* pDevice = NULL)
	{
		...
		if (pDevice == NULL)
		{
			return (Status_)niteInitializeHandTracker(&m_handTrackerHandle);
			// Pick a device
		}
		return (Status_)niteInitializeHandTrackerByDevice(pDevice, &m_handTrackerHandle);
	}
	...
	*/
	...
	@returns Status code indicating whether this operation was successful.
	*/
	Status_ readFrame(HandTrackerFrameRef* pFrame)
	{
		NiteHandTrackerFrame *pNiteFrame = NULL;
		Status_ rc = (Status_)niteReadHandTrackerFrame(m_handTrackerHandle, &pNiteFrame);
	...
	*/
	...
	@returns Status code indicating success or failure of this operation.
	*/
	Status_ setSmoothingFactor(float factor)
	{
		return (Status_)niteSetHandSmoothingFactor(m_handTrackerHandle, factor);
	}
	...
	*/
	...
	{
		float factor;
		Status_ rc = (Status_)niteGetHandSmoothingFactor(m_handTrackerHandle, &factor);
		if (rc != STATUS_OK)
		{
			factor = 0;
		}
	...
	@returns @ref Status code indicating success or failure of this operation.
	*/
	Status_ startHandTracking(const Point3f& position, HandId* pNewHandId)
	{
		return (Status_)niteStartHandTracking(m_handTrackerHandle, (const NitePoint3f*)&position, pNewHandId);
	}
	...
	*/
	Status_ startGestureDetection(GestureType type)
	{
		return (Status_)niteStartGestureDetection(m_handTrackerHandle, (NiteGestureType)type);
	}
	...
	*/
	...
	convert between coordinate systems requires a properly initalized Device from OpenNI 2.0.
	*/
	Status_ convertHandCoordinatesToDepth(float x, float y, float z, float* pOutX, float* pOutY) const
	{
		return (Status_)niteConvertHandCoordinatesToDepth(m_handTrackerHandle, x, y, z, pOutX, pOutY);
	}
	...
	convert between coordinate systems requires a properly initalized Device from OpenNI 2.0.
	*/
	Status_ convertDepthCoordinatesToHand(int x, int y, int z, float* pOutX, float* pOutY) const
	{
		return (Status_)niteConvertDepthCoordinatesToHand(m_handTrackerHandle, x, y, z, pOutX, pOutY);
	}
